...
public final class DomainFlightInfoConsts {
    ...
    public static final String FLIGHT_ERROR = "请输入航班";
    public static final String DEPART_PLACE_ERROR = "请输入出发城市";
    public static final String DESTINATION_ERROR = "请输入到达城市";
    public static final String DEPART_TIME_ERROR = "请输入出发时间";
    public static final String ARRIVED_TIME_ERROR = "请输入到达时间";
    public static final String ECONOMY_PRICE_ERROR = "请输入经济舱票价";
